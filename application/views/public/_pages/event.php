  ...
  <?php
    ...
    if ($total_records > 0) 
    {
      ...
      $events = $CI->db->get('event')->result_array();  
...
<!--  -->
     ...
     <!--  -->   
        <div class="row">
          ...
          <!-- ========================== -->
          <div class="col-lg-9">
            <h3 class="page-heading-mb">All Events</h3>
               ...
               <div class="col-lg-5"  style="background-color:#0066c1;padding: 20px;">   
                 <div class="clearfix">   
                  ...
                  <div class="entry-share clearfix">
                    <div class="entry-button"> <a class="button arrow text-white" href="<?php echo base_url('event/'.$single['slug']) ?>">Read More<i class="fa fa-angle-right" aria-hidden="true"></i></a>
                    </div>
                  </div> 
               </div> 
