    ...
    <section class="blog blog-grid-2-sidebar white-bg page-section-ptb">
      <div class="container">
        <div class="row">
          ...
          <!-- ========================== -->
          <div class="col-lg-9">
              <h3 class="page-heading-mb">All Courses</h3>
            <div class="row">
            <?php foreach ($courses as $single) { ?> 
            <div class="col-lg-6 col-md-6 col-sm-6">
              <div class="blog-entry mb-30">
                <div class="entry-image clearfix">
                  <a href="<?php echo base_url('course/'.$single['slug']) ?>">
                ...
                <div class="blog-detail">
                  <div class="entry-title mb-10"> <a href="<?php echo base_url('course/'.$single['slug']) ?>"><?php echo $single['title'] ?></a>
                  </div>
                  <div class="entry-content">
                    <p><?php echo excerpt($single['excerpt']) ?></p>
                  </div>
                  <div class="entry-share clearfix">
                    <div class="entry-button"> <a class="button arrow" href="<?php echo base_url('course/'.$single['slug']) ?>">Read More<i class="fa fa-angle-right" aria-hidden="true"></i></a>
                    </div>
                  </div>
                </div>
              </div>
